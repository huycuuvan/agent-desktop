...
import { AdsPowerProfileRepositoryImpl } from "../adspower/AdsPowerProfileRepositoryImpl.js";
import { CdpBrowserTabReader } from "../browser/CdpBrowserTabReader.js";
import { RefreshExecutor } from "../browser/RefreshExecutor.js";
import { CampaignSearchExecutor } from "../browser/CampaignSearchExecutor.js";
import { CampaignTableReader } from "../browser/CampaignTableReader.js";
import { GoogleAdsCollector } from "../browser/GoogleAdsCollector.js";
import { GoogleAdsDateRangeExecutor } from "../browser/GoogleAdsDateRangeExecutor.js";
import { GoogleAdsTableReadinessWaiter } from "../browser/googleAdsTableReadiness.js";
...
import type { CollectorRunner } from "../../domain/repositories/CollectorRunner.js";
...
/**
 * Wraps the full Phase 1 collector pipeline (AdsPower -> CDP -> Google Ads tab
 * detection -> per-tab collection) behind the CollectorRunner port, so it can
 * be reused by both `pnpm dev` and the Phase 4 scheduler without duplicating
 * the AdsPower/Playwright wiring.
 */
export class GoogleAdsCollectorRunner implements CollectorRunner {
